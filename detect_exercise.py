...
# detect_exercise.py があるディレクトリ
BASE_DIR = Path(__file__).resolve().parent

# 自分自身のディレクトリをimport対象にする
...
from train_2class_lstm import LSTMClassifier
...
# 入力動画
# ------------------------------------------------------------
VIDEO_PATH = r"C:\Users\池田一颯\internship\video\YTDown.com_YouTube_Media_i-2RWGuSyN0_002_720p.mp4"
#VIDEO_PATH = (
#    BASE_DIR
#    / "videos"
#    / "test.mp4"
